	...
	$(document).ready(function() {
		$('#email_check').click(function(){
			...
			$.ajax({
	              ...
	              {
	            	  if(response == '입력하신 아이디와 이메일로 일치하는 아이디가 없습니다.'){
	            		  alert(response);
	            	  }else{
		...
		$('#searchPwBtn').click(function(){
			...
			alert('이메일로 비밀번호를 보냈습니다. 확인 해주세요.');
...
<div class="container">
	...
	<form action="search_pw_click" name="searchPw">
		<div class="row justify-content-center ">
			<div class="col-4 mb-3 gy-2">
				<label for="exampleFormControlInput1" class="form-label">아이디
					...
					id="uid" placeholder="이름을 입력해 주세요">
			</div>
		</div>
		...
		<div class="row justify-content-center my-3">
			<div class="d-grid gap-2 col-4 mx-auto">
				<button class="btn btn-primary" type="button"
					name="searchIdBtn" id="searchPwBtn"
