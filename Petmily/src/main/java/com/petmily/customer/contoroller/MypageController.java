...
public class MypageController {
	...
	@RequestMapping("/mypage_modify_update_complete")
	public String myPageModifyUpdateComplete(MultipartHttpServletRequest request, Model model, MultipartFile file ) throws Exception {
		session = request.getSession();
		
		
		service.myPageModifyUpdateComplete(request, model , file , session);
